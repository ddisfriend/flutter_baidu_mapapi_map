...
class BMFWidgetMarker extends BMFOverlay {
  ...
  BMFWidgetMarker({
    ...
    bool visible: true,
        ...
        assert(widget != null), // ignore: unnecessary_null_comparison
        super(zIndex: zIndex, visible: visible);

  /// map => BMFMarker
  BMFWidgetMarker.fromMap(Map map)
  ...
  @override
  fromMap(Map map) {
    return BMFWidgetMarker.fromMap(map);
  }

  Uint8List? widgetData;
  ...
  /// 更新显示的图片
  /// todo
  Future<bool> updateMarker(Widget widget) async {
